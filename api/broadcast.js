export default async function handler(req, res) {
    ...
    // --- SMART BUTTON LOGIC ---
    let buttonConfig = {};
    // Sets your actual live Vercel URL as the default fallback
    const finalUrl = mini_app_url || "https://link-earning.vercel.app/";
    
    // If the URL is a Telegram link, use normal 'url', otherwise use 'web_app'
    ...
    for (const chat_id of chat_ids) {
        try {
            ...
            // Delay to prevent hitting Telegram API rate limits (30 messages per second)
